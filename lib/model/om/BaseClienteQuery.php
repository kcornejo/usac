 ...
 *
 * @method ClienteQuery leftJoinMovimiento($relationAlias = null) Adds a LEFT JOIN clause to the query using the Movimiento relation
 * @method ClienteQuery rightJoinMovimiento($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Movimiento relation
 * @method ClienteQuery innerJoinMovimiento($relationAlias = null) Adds a INNER JOIN clause to the query using the Movimiento relation
 *
...
abstract class BaseClienteQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT `ID`, `NOMBRE`, `CORREO`, `DIRECCION`, `TELEFONO`, `CIUDAD`, `OBSERVACION`, `PUNTOS`, `NIT` FROM `cliente` WHERE `ID` = :p0';
        try {
    ...
    public function filterByMovimiento($movimiento, $comparison = null)
    {
        if ($movimiento instanceof Movimiento) {
            return $this
                ->addUsingAlias(ClientePeer::ID, $movimiento->getClienteId(), $comparison);
