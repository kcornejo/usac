...
/**
 * Base static class for performing query and update operations on the 'factura_detalle' table.
 *
 * 
 *
...
abstract class BaseFacturaDetallePeer
{
    ...
    const OM_CLASS = 'FacturaDetalle';

    /** the related TableMap class for this table */
    const TM_CLASS = 'FacturaDetalleTableMap';
    ...
    const PROVEEDOR_ID = 'factura_detalle.PROVEEDOR_ID';
    ...
    /**
     * An identiy map to hold any loaded instances of FacturaDetalle objects.
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'FacturaId', 'ProductoId', 'ProveedorId', 'Cantidad', 'PrecioUnitario', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'facturaId', 'productoId', 'proveedorId', 'cantidad', 'precioUnitario', ),
        BasePeer::TYPE_COLNAME => array (FacturaDetallePeer::ID, FacturaDetallePeer::FACTURA_ID, FacturaDetallePeer::PRODUCTO_ID, FacturaDetallePeer::PROVEEDOR_ID, FacturaDetallePeer::CANTIDAD, FacturaDetallePeer::PRECIO_UNITARIO, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'FACTURA_ID', 'PRODUCTO_ID', 'PROVEEDOR_ID', 'CANTIDAD', 'PRECIO_UNITARIO', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'factura_id', 'producto_id', 'proveedor_id', 'cantidad', 'precio_unitario', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'FacturaId' => 1, 'ProductoId' => 2, 'ProveedorId' => 3, 'Cantidad' => 4, 'PrecioUnitario' => 5, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'facturaId' => 1, 'productoId' => 2, 'proveedorId' => 3, 'cantidad' => 4, 'precioUnitario' => 5, ),
        BasePeer::TYPE_COLNAME => array (FacturaDetallePeer::ID => 0, FacturaDetallePeer::FACTURA_ID => 1, FacturaDetallePeer::PRODUCTO_ID => 2, FacturaDetallePeer::PROVEEDOR_ID => 3, FacturaDetallePeer::CANTIDAD => 4, FacturaDetallePeer::PRECIO_UNITARIO => 5, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'FACTURA_ID' => 1, 'PRODUCTO_ID' => 2, 'PROVEEDOR_ID' => 3, 'CANTIDAD' => 4, 'PRECIO_UNITARIO' => 5, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'factura_id' => 1, 'producto_id' => 2, 'proveedor_id' => 3, 'cantidad' => 4, 'precio_unitario' => 5, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, )
    );
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(FacturaDetallePeer::PROVEEDOR_ID);
    ...
    public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
    {
        ...
        {
          call_user_func($sf_hook, 'BaseFacturaDetallePeer', $criteria, $con);
        }
    ...
    public static function doCountJoinProveedor(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(FacturaDetallePeer::PROVEEDOR_ID, ProveedorPeer::ID, $join_behavior);
    ...
    /**
     * Selects a collection of FacturaDetalle objects pre-filled with their Proveedor objects.
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
     * @return array           Array of FacturaDetalle objects.
    ...
    public static function doSelectJoinProveedor(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (FacturaDetalle) to $obj2 (Proveedor)
                $obj2->addFacturaDetalle($obj1);
    ...
    public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key3 !== null) {
                ...
                // Add the $obj1 (FacturaDetalle) to the collection in $obj3 (Producto)
            ...
            if ($key4 !== null) {
                ...
                // Add the $obj1 (FacturaDetalle) to the collection in $obj4 (Proveedor)
                $obj4->addFacturaDetalle($obj1);
            } // if joined row not null
    ...
    public static function doSelectJoinAllExceptFactura(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if (null !== ($obj1 = FacturaDetallePeer::getInstanceFromPool($key1))) {
                ...
                // Add the $obj1 (FacturaDetalle) to the collection in $obj3 (Proveedor)
                $obj3->addFacturaDetalle($obj1);
    ...
    /**
     * Selects a collection of FacturaDetalle objects pre-filled with all related objects except Proveedor.
     *
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    public static function buildTableMap()
    {
      ...
      if (!$dbMap->hasTable(BaseFacturaDetallePeer::TABLE_NAME)) {
        $dbMap->addTableObject(new FacturaDetalleTableMap());
      }
    }
    ...
    static private function getMixerPreSelectHook($method)
    {
      ...
      {
        return sprintf('BaseFacturaDetallePeer:%s:%1$s', 'Count' == $match[1] ? 'doCount' : $match[0]);
      }
