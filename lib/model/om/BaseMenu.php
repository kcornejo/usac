...
abstract class BaseMenu extends BaseObject implements Persistent
{
    ...
    public function setModulo($v)
    {
        ...
        if ($this->modulo !== $v) {
            $this->modulo = $v;
            $this->modifiedColumns[] = MenuPeer::MODULO;
        }
    ...
    public function setAccion($v)
    {
        ...
        if ($this->accion !== $v) {
            $this->accion = $v;
            $this->modifiedColumns[] = MenuPeer::ACCION;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->accion = ($row[$startcol + 3] !== null) ? (string) $row[$startcol + 3] : null;
            ...
            return $startcol + 11; // 11 = MenuPeer::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(MenuPeer::DESCRIPCION)) {
            $modifiedColumns[':p' . $index++]  = '`DESCRIPCION`';
        }
        if ($this->isColumnModified(MenuPeer::MODULO)) {
            $modifiedColumns[':p' . $index++]  = '`MODULO`';
        }
        if ($this->isColumnModified(MenuPeer::ACCION)) {
            $modifiedColumns[':p' . $index++]  = '`ACCION`';
        }
        if ($this->isColumnModified(MenuPeer::ICONO)) {
            $modifiedColumns[':p' . $index++]  = '`ICONO`';
        }
        if ($this->isColumnModified(MenuPeer::ORDEN)) {
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[3], $arr)) $this->setAccion($arr[$keys[3]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(MenuPeer::MODULO)) $criteria->add(MenuPeer::MODULO, $this->modulo);
        if ($this->isColumnModified(MenuPeer::ACCION)) $criteria->add(MenuPeer::ACCION, $this->accion);
    ...
    public function __call($name, $params)
    {
        ...
        // symfony_behaviors behavior
        if ($callable = sfMixer::getCallable('BaseMenu:' . $name))
        {
