...
abstract class BaseTipoUsuario extends BaseObject implements Persistent
{
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = TipoUsuarioPeer::ID;
        }
    ...
    public function setNombre($v)
    {
        ...
        if ($this->nombre !== $v) {
            $this->nombre = $v;
            $this->modifiedColumns[] = TipoUsuarioPeer::NOMBRE;
        }
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(TipoUsuarioPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`ID`';
        }
        if ($this->isColumnModified(TipoUsuarioPeer::NOMBRE)) {
            $modifiedColumns[':p' . $index++]  = '`NOMBRE`';
        }
        if ($this->isColumnModified(TipoUsuarioPeer::DESCRIPCION)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(TipoUsuarioPeer::ID)) $criteria->add(TipoUsuarioPeer::ID, $this->id);
        if ($this->isColumnModified(TipoUsuarioPeer::NOMBRE)) $criteria->add(TipoUsuarioPeer::NOMBRE, $this->nombre);
    ...
    {
        $criteria = new Criteria(TipoUsuarioPeer::DATABASE_NAME);
        $criteria->add(TipoUsuarioPeer::ID, $this->id);
