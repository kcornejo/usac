...
/**
 * Base class that represents a row from the 'movimiento' table.
 *
 * 
 *
 ...
 */
abstract class BaseMovimiento extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'MovimientoPeer';
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = MovimientoPeer::ID;
        }
    ...
    public function setProveedorId($v)
    {
        ...
        if ($this->proveedor_id !== $v) {
            $this->proveedor_id = $v;
            $this->modifiedColumns[] = MovimientoPeer::PROVEEDOR_ID;
        }
    ...
    public function setClienteId($v)
    {
        ...
        if ($this->cliente_id !== $v) {
            $this->cliente_id = $v;
            $this->modifiedColumns[] = MovimientoPeer::CLIENTE_ID;
        }
    ...
    public function setTipoMovimiento($v)
    {
        ...
        if ($this->tipo_movimiento !== $v) {
            ...
            $this->modifiedColumns[] = MovimientoPeer::TIPO_MOVIMIENTO;
        }
    ...
    public function setProductoId($v)
    {
        ...
        if ($this->producto_id !== $v) {
            $this->producto_id = $v;
            $this->modifiedColumns[] = MovimientoPeer::PRODUCTO_ID;
        }
    ...
    public function setCantidad($v)
    {
        ...
        if ($this->cantidad !== $v) {
            $this->cantidad = $v;
            $this->modifiedColumns[] = MovimientoPeer::CANTIDAD;
        }
    ...
    public function setFecha($v)
    {
        ...
        if ($this->fecha !== $v) {
            $this->fecha = $v;
            $this->modifiedColumns[] = MovimientoPeer::FECHA;
        }
    ...
    public function setPrecio($v)
    {
        ...
        if ($this->precio !== $v) {
            $this->precio = $v;
            $this->modifiedColumns[] = MovimientoPeer::PRECIO;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->tipo_movimiento = ($row[$startcol + 3] !== null) ? (string) $row[$startcol + 3] : null;
            ...
            return $startcol + 8; // 8 = MovimientoPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating Movimiento object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = MovimientoPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = MovimientoQuery::create()
                ->filterByPrimaryKey($this->getPrimaryKey());
            $ret = $this->preDelete($con);
            // symfony_behaviors behavior
            foreach (sfMixer::getCallables('BaseMovimiento:delete:pre') as $callable)
            {
            ...
            if ($ret) {
                ...
                $this->postDelete($con);
                // symfony_behaviors behavior
                foreach (sfMixer::getCallables('BaseMovimiento:delete:post') as $callable)
                {
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            // symfony_behaviors behavior
            foreach (sfMixer::getCallables('BaseMovimiento:save:pre') as $callable)
            {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                // symfony_behaviors behavior
                foreach (sfMixer::getCallables('BaseMovimiento:save:post') as $callable)
                {
                  call_user_func($callable, $this, $con, $affectedRows);
                }

                MovimientoPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(MovimientoPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`ID`';
        }
        if ($this->isColumnModified(MovimientoPeer::PROVEEDOR_ID)) {
            $modifiedColumns[':p' . $index++]  = '`PROVEEDOR_ID`';
        }
        if ($this->isColumnModified(MovimientoPeer::CLIENTE_ID)) {
            $modifiedColumns[':p' . $index++]  = '`CLIENTE_ID`';
        }
        if ($this->isColumnModified(MovimientoPeer::TIPO_MOVIMIENTO)) {
            $modifiedColumns[':p' . $index++]  = '`TIPO_MOVIMIENTO`';
        }
        if ($this->isColumnModified(MovimientoPeer::PRODUCTO_ID)) {
            $modifiedColumns[':p' . $index++]  = '`PRODUCTO_ID`';
        }
        if ($this->isColumnModified(MovimientoPeer::CANTIDAD)) {
            $modifiedColumns[':p' . $index++]  = '`CANTIDAD`';
        }
        if ($this->isColumnModified(MovimientoPeer::FECHA)) {
            $modifiedColumns[':p' . $index++]  = '`FECHA`';
        }
        if ($this->isColumnModified(MovimientoPeer::PRECIO)) {
            $modifiedColumns[':p' . $index++]  = '`PRECIO`';
        }

        $sql = sprintf(
            'INSERT INTO `movimiento` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = MovimientoPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = MovimientoPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[3], $arr)) $this->setTipoMovimiento($arr[$keys[3]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(MovimientoPeer::ID)) $criteria->add(MovimientoPeer::ID, $this->id);
        if ($this->isColumnModified(MovimientoPeer::PROVEEDOR_ID)) $criteria->add(MovimientoPeer::PROVEEDOR_ID, $this->proveedor_id);
        if ($this->isColumnModified(MovimientoPeer::CLIENTE_ID)) $criteria->add(MovimientoPeer::CLIENTE_ID, $this->cliente_id);
        if ($this->isColumnModified(MovimientoPeer::TIPO_MOVIMIENTO)) $criteria->add(MovimientoPeer::TIPO_MOVIMIENTO, $this->tipo_movimiento);
        if ($this->isColumnModified(MovimientoPeer::PRODUCTO_ID)) $criteria->add(MovimientoPeer::PRODUCTO_ID, $this->producto_id);
        if ($this->isColumnModified(MovimientoPeer::CANTIDAD)) $criteria->add(MovimientoPeer::CANTIDAD, $this->cantidad);
        if ($this->isColumnModified(MovimientoPeer::FECHA)) $criteria->add(MovimientoPeer::FECHA, $this->fecha);
        if ($this->isColumnModified(MovimientoPeer::PRECIO)) $criteria->add(MovimientoPeer::PRECIO, $this->precio);
    ...
    {
        $criteria = new Criteria(MovimientoPeer::DATABASE_NAME);
        $criteria->add(MovimientoPeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of Movimiento (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return Movimiento Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return MovimientoPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new MovimientoPeer();
        }
    ...
    public function getProveedor(PropelPDO $con = null)
    {
        if ($this->aProveedor === null && ($this->proveedor_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aProveedor->addMovimientos($this);
             */
        }
    ...
    public function getCliente(PropelPDO $con = null)
    {
        if ($this->aCliente === null && ($this->cliente_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aCliente->addMovimientos($this);
             */
        }
    ...
    public function getProducto(PropelPDO $con = null)
    {
        if ($this->aProducto === null && ($this->producto_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aProducto->addMovimientos($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(MovimientoPeer::DEFAULT_STRING_FORMAT);
    }
    ...
    public function __call($name, $params)
    {
        ...
        // symfony_behaviors behavior
        if ($callable = sfMixer::getCallable('BaseMovimiento:' . $name))
        {
