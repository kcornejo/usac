...
abstract class BaseProveedorPeer
{
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'Nombre', 'Direccion', 'CorreoEletronico', 'NombreContacto', 'Telefono', 'Ciudad', 'Observacion', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'nombre', 'direccion', 'correoEletronico', 'nombreContacto', 'telefono', 'ciudad', 'observacion', ),
        BasePeer::TYPE_COLNAME => array (ProveedorPeer::ID, ProveedorPeer::NOMBRE, ProveedorPeer::DIRECCION, ProveedorPeer::CORREO_ELETRONICO, ProveedorPeer::NOMBRE_CONTACTO, ProveedorPeer::TELEFONO, ProveedorPeer::CIUDAD, ProveedorPeer::OBSERVACION, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'NOMBRE', 'DIRECCION', 'CORREO_ELETRONICO', 'NOMBRE_CONTACTO', 'TELEFONO', 'CIUDAD', 'OBSERVACION', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'nombre', 'direccion', 'correo_eletronico', 'nombre_contacto', 'telefono', 'ciudad', 'observacion', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Nombre' => 1, 'Direccion' => 2, 'CorreoEletronico' => 3, 'NombreContacto' => 4, 'Telefono' => 5, 'Ciudad' => 6, 'Observacion' => 7, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'nombre' => 1, 'direccion' => 2, 'correoEletronico' => 3, 'nombreContacto' => 4, 'telefono' => 5, 'ciudad' => 6, 'observacion' => 7, ),
        BasePeer::TYPE_COLNAME => array (ProveedorPeer::ID => 0, ProveedorPeer::NOMBRE => 1, ProveedorPeer::DIRECCION => 2, ProveedorPeer::CORREO_ELETRONICO => 3, ProveedorPeer::NOMBRE_CONTACTO => 4, ProveedorPeer::TELEFONO => 5, ProveedorPeer::CIUDAD => 6, ProveedorPeer::OBSERVACION => 7, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'NOMBRE' => 1, 'DIRECCION' => 2, 'CORREO_ELETRONICO' => 3, 'NOMBRE_CONTACTO' => 4, 'TELEFONO' => 5, 'CIUDAD' => 6, 'OBSERVACION' => 7, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'nombre' => 1, 'direccion' => 2, 'correo_eletronico' => 3, 'nombre_contacto' => 4, 'telefono' => 5, 'ciudad' => 6, 'observacion' => 7, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, 7, )
    );
