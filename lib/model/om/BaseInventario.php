...
abstract class BaseInventario extends BaseObject implements Persistent
{
    ...
    public function setPrecioCompra($v)
    {
        ...
        if ($this->precio_compra !== $v) {
            ...
            $this->modifiedColumns[] = InventarioPeer::PRECIO_COMPRA;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->precio_compra = ($row[$startcol + 3] !== null) ? (double) $row[$startcol + 3] : null;
            ...
            return $startcol + 9; // 9 = InventarioPeer::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(InventarioPeer::PRECIO_COMPRA)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(InventarioPeer::PRECIO_COMPRA)) $criteria->add(InventarioPeer::PRECIO_COMPRA, $this->precio_compra);
    ...
    public function __call($name, $params)
    {
        ...
        // symfony_behaviors behavior
        if ($callable = sfMixer::getCallable('BaseInventario:' . $name))
        {
