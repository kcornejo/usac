...
/**
 * Base class that represents a row from the 'tipo_presentacion' table.
 *
 * 
 *
 ...
 */
abstract class BaseTipoPresentacion extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'TipoPresentacionPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        TipoPresentacionPeer
     */
     ...
     * @return TipoPresentacion The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = TipoPresentacionPeer::ID;
        }
    ...
    public function setDescripcion($v)
    {
        ...
        if ($this->descripcion !== $v) {
            $this->descripcion = $v;
            $this->modifiedColumns[] = TipoPresentacionPeer::DESCRIPCION;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = TipoPresentacionPeer::CREATED_AT;
            }
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = TipoPresentacionPeer::UPDATED_AT;
            }
        } // if either are not null
    ...
    public function setCreatedBy($v)
    {
        ...
        if ($this->created_by !== $v) {
            $this->created_by = $v;
            $this->modifiedColumns[] = TipoPresentacionPeer::CREATED_BY;
        }
    ...
    public function setUpdatedBy($v)
    {
        ...
        if ($this->updated_by !== $v) {
            $this->updated_by = $v;
            $this->modifiedColumns[] = TipoPresentacionPeer::UPDATED_BY;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 6; // 6 = TipoPresentacionPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating TipoPresentacion object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = TipoPresentacionPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = TipoPresentacionQuery::create()
                ->filterByPrimaryKey($this->getPrimaryKey());
            $ret = $this->preDelete($con);
            // symfony_behaviors behavior
            foreach (sfMixer::getCallables('BaseTipoPresentacion:delete:pre') as $callable)
            {
            ...
            if ($ret) {
                ...
                $this->postDelete($con);
                // symfony_behaviors behavior
                foreach (sfMixer::getCallables('BaseTipoPresentacion:delete:post') as $callable)
                {
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            // symfony_behaviors behavior
            foreach (sfMixer::getCallables('BaseTipoPresentacion:save:pre') as $callable)
            {
            ...
            if ($this->isModified() && !$this->isColumnModified(TipoPresentacionPeer::UPDATED_AT))
            {
            ...
            if ($isInsert) {
                ...
                // symfony_timestampable behavior
                if (!$this->isColumnModified(TipoPresentacionPeer::CREATED_AT))
                {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                // symfony_behaviors behavior
                foreach (sfMixer::getCallables('BaseTipoPresentacion:save:post') as $callable)
                {
                  call_user_func($callable, $this, $con, $affectedRows);
                }

                TipoPresentacionPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(TipoPresentacionPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`ID`';
        }
        if ($this->isColumnModified(TipoPresentacionPeer::DESCRIPCION)) {
            $modifiedColumns[':p' . $index++]  = '`DESCRIPCION`';
        }
        if ($this->isColumnModified(TipoPresentacionPeer::CREATED_AT)) {
            $modifiedColumns[':p' . $index++]  = '`CREATED_AT`';
        }
        if ($this->isColumnModified(TipoPresentacionPeer::UPDATED_AT)) {
            $modifiedColumns[':p' . $index++]  = '`UPDATED_AT`';
        }
        if ($this->isColumnModified(TipoPresentacionPeer::CREATED_BY)) {
            $modifiedColumns[':p' . $index++]  = '`CREATED_BY`';
        }
        if ($this->isColumnModified(TipoPresentacionPeer::UPDATED_BY)) {
            $modifiedColumns[':p' . $index++]  = '`UPDATED_BY`';
        }

        $sql = sprintf(
            'INSERT INTO `tipo_presentacion` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = TipoPresentacionPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = TipoPresentacionPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['TipoPresentacion'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['TipoPresentacion'][$this->getPrimaryKey()] = true;
        $keys = TipoPresentacionPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(TipoPresentacionPeer::ID)) $criteria->add(TipoPresentacionPeer::ID, $this->id);
        if ($this->isColumnModified(TipoPresentacionPeer::DESCRIPCION)) $criteria->add(TipoPresentacionPeer::DESCRIPCION, $this->descripcion);
        if ($this->isColumnModified(TipoPresentacionPeer::CREATED_AT)) $criteria->add(TipoPresentacionPeer::CREATED_AT, $this->created_at);
        if ($this->isColumnModified(TipoPresentacionPeer::UPDATED_AT)) $criteria->add(TipoPresentacionPeer::UPDATED_AT, $this->updated_at);
        if ($this->isColumnModified(TipoPresentacionPeer::CREATED_BY)) $criteria->add(TipoPresentacionPeer::CREATED_BY, $this->created_by);
        if ($this->isColumnModified(TipoPresentacionPeer::UPDATED_BY)) $criteria->add(TipoPresentacionPeer::UPDATED_BY, $this->updated_by);
    ...
    {
        $criteria = new Criteria(TipoPresentacionPeer::DATABASE_NAME);
        $criteria->add(TipoPresentacionPeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of TipoPresentacion (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return TipoPresentacion Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return TipoPresentacionPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new TipoPresentacionPeer();
        }
     ...
     * If this TipoPresentacion is new, it will return
    ...
    public function setProductos(PropelCollection $productos, PropelPDO $con = null)
    {
        ...
        foreach ($this->productosScheduledForDeletion as $productoRemoved) {
            $productoRemoved->setTipoPresentacion(null);
        }
    ...
    protected function doAddProducto($producto)
    {
        ...
        $producto->setTipoPresentacion($this);
    }
    ...
    public function __call($name, $params)
    {
        ...
        // symfony_behaviors behavior
        if ($callable = sfMixer::getCallable('BaseTipoPresentacion:' . $name))
        {
