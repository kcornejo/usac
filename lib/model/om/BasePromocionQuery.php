 ...
 * @method PromocionQuery orderByActivo($order = Criteria::ASC) Order by the activo column
 ...
 * @method PromocionQuery groupByActivo() Group by the activo column
 ...
 * @method Promocion findOneByActivo(boolean $activo) Return the first Promocion filtered by the activo column
 ...
 * @method Promocion findOneByDescuento(double $descuento) Return the first Promocion filtered by the descuento column
 *
 * @method array findById(int $id) Return Promocion objects filtered by the id column
 * @method array findByActivo(boolean $activo) Return Promocion objects filtered by the activo column
 ...
 * @method array findByDescuento(double $descuento) Return Promocion objects filtered by the descuento column
 *
...
abstract class BasePromocionQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT `ID`, `ACTIVO`, `FECHA_INICIO`, `FECHA_FIN`, `PRODUCTO_ID`, `DESCUENTO` FROM `promocion` WHERE `ID` = :p0';
        try {
    ...
    public function filterByActivo($activo = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(PromocionPeer::ACTIVO, $activo, $comparison);
    }
     ...
     * Example usage:
     * <code>
     * $query->filterByFechaFin('fooValue');   // WHERE fecha_fin = 'fooValue'
     * $query->filterByFechaFin('%fooValue%'); // WHERE fecha_fin LIKE '%fooValue%'
     * </code>
     *
