...
abstract class BaseFacturaPeer
{
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'ClienteId', 'CreatedAt', 'UpdatedAt', 'CreatedBy', 'UpdatedBy', 'Total', 'TipoPagoId', 'Activo', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'clienteId', 'createdAt', 'updatedAt', 'createdBy', 'updatedBy', 'total', 'tipoPagoId', 'activo', ),
        BasePeer::TYPE_COLNAME => array (FacturaPeer::ID, FacturaPeer::CLIENTE_ID, FacturaPeer::CREATED_AT, FacturaPeer::UPDATED_AT, FacturaPeer::CREATED_BY, FacturaPeer::UPDATED_BY, FacturaPeer::TOTAL, FacturaPeer::TIPO_PAGO_ID, FacturaPeer::ACTIVO, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'CLIENTE_ID', 'CREATED_AT', 'UPDATED_AT', 'CREATED_BY', 'UPDATED_BY', 'TOTAL', 'TIPO_PAGO_ID', 'ACTIVO', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'cliente_id', 'created_at', 'updated_at', 'created_by', 'updated_by', 'total', 'tipo_pago_id', 'activo', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'ClienteId' => 1, 'CreatedAt' => 2, 'UpdatedAt' => 3, 'CreatedBy' => 4, 'UpdatedBy' => 5, 'Total' => 6, 'TipoPagoId' => 7, 'Activo' => 8, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'clienteId' => 1, 'createdAt' => 2, 'updatedAt' => 3, 'createdBy' => 4, 'updatedBy' => 5, 'total' => 6, 'tipoPagoId' => 7, 'activo' => 8, ),
        BasePeer::TYPE_COLNAME => array (FacturaPeer::ID => 0, FacturaPeer::CLIENTE_ID => 1, FacturaPeer::CREATED_AT => 2, FacturaPeer::UPDATED_AT => 3, FacturaPeer::CREATED_BY => 4, FacturaPeer::UPDATED_BY => 5, FacturaPeer::TOTAL => 6, FacturaPeer::TIPO_PAGO_ID => 7, FacturaPeer::ACTIVO => 8, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'CLIENTE_ID' => 1, 'CREATED_AT' => 2, 'UPDATED_AT' => 3, 'CREATED_BY' => 4, 'UPDATED_BY' => 5, 'TOTAL' => 6, 'TIPO_PAGO_ID' => 7, 'ACTIVO' => 8, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'cliente_id' => 1, 'created_at' => 2, 'updated_at' => 3, 'created_by' => 4, 'updated_by' => 5, 'total' => 6, 'tipo_pago_id' => 7, 'activo' => 8, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, 7, 8, )
    );
