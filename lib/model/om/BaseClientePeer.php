...
abstract class BaseClientePeer
{
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'Nombre', 'Correo', 'Direccion', 'Telefono', 'Ciudad', 'Observacion', 'Puntos', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'nombre', 'correo', 'direccion', 'telefono', 'ciudad', 'observacion', 'puntos', ),
        BasePeer::TYPE_COLNAME => array (ClientePeer::ID, ClientePeer::NOMBRE, ClientePeer::CORREO, ClientePeer::DIRECCION, ClientePeer::TELEFONO, ClientePeer::CIUDAD, ClientePeer::OBSERVACION, ClientePeer::PUNTOS, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'NOMBRE', 'CORREO', 'DIRECCION', 'TELEFONO', 'CIUDAD', 'OBSERVACION', 'PUNTOS', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'nombre', 'correo', 'direccion', 'telefono', 'ciudad', 'observacion', 'puntos', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Nombre' => 1, 'Correo' => 2, 'Direccion' => 3, 'Telefono' => 4, 'Ciudad' => 5, 'Observacion' => 6, 'Puntos' => 7, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'nombre' => 1, 'correo' => 2, 'direccion' => 3, 'telefono' => 4, 'ciudad' => 5, 'observacion' => 6, 'puntos' => 7, ),
        BasePeer::TYPE_COLNAME => array (ClientePeer::ID => 0, ClientePeer::NOMBRE => 1, ClientePeer::CORREO => 2, ClientePeer::DIRECCION => 3, ClientePeer::TELEFONO => 4, ClientePeer::CIUDAD => 5, ClientePeer::OBSERVACION => 6, ClientePeer::PUNTOS => 7, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'NOMBRE' => 1, 'CORREO' => 2, 'DIRECCION' => 3, 'TELEFONO' => 4, 'CIUDAD' => 5, 'OBSERVACION' => 6, 'PUNTOS' => 7, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'nombre' => 1, 'correo' => 2, 'direccion' => 3, 'telefono' => 4, 'ciudad' => 5, 'observacion' => 6, 'puntos' => 7, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, 7, )
    );
