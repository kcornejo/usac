...
abstract class BasePromocionPeer
{
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'Activo', 'FechaInicio', 'FechaFin', 'ProductoId', 'Descuento', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'activo', 'fechaInicio', 'fechaFin', 'productoId', 'descuento', ),
        BasePeer::TYPE_COLNAME => array (PromocionPeer::ID, PromocionPeer::ACTIVO, PromocionPeer::FECHA_INICIO, PromocionPeer::FECHA_FIN, PromocionPeer::PRODUCTO_ID, PromocionPeer::DESCUENTO, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'ACTIVO', 'FECHA_INICIO', 'FECHA_FIN', 'PRODUCTO_ID', 'DESCUENTO', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'activo', 'fecha_inicio', 'fecha_fin', 'producto_id', 'descuento', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Activo' => 1, 'FechaInicio' => 2, 'FechaFin' => 3, 'ProductoId' => 4, 'Descuento' => 5, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'activo' => 1, 'fechaInicio' => 2, 'fechaFin' => 3, 'productoId' => 4, 'descuento' => 5, ),
        BasePeer::TYPE_COLNAME => array (PromocionPeer::ID => 0, PromocionPeer::ACTIVO => 1, PromocionPeer::FECHA_INICIO => 2, PromocionPeer::FECHA_FIN => 3, PromocionPeer::PRODUCTO_ID => 4, PromocionPeer::DESCUENTO => 5, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'ACTIVO' => 1, 'FECHA_INICIO' => 2, 'FECHA_FIN' => 3, 'PRODUCTO_ID' => 4, 'DESCUENTO' => 5, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'activo' => 1, 'fecha_inicio' => 2, 'fecha_fin' => 3, 'producto_id' => 4, 'descuento' => 5, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, )
    );
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(PromocionPeer::ACTIVO);
