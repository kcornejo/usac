...
/**
 * Base class that represents a row from the 'factura_detalle' table.
 *
 * 
 *
...
abstract class BaseFacturaDetalle extends BaseObject implements Persistent
{
    ...
    public function setProveedorId($v)
    {
        ...
        if ($this->proveedor_id !== $v) {
            $this->proveedor_id = $v;
            $this->modifiedColumns[] = FacturaDetallePeer::PROVEEDOR_ID;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->precio_unitario = ($row[$startcol + 5] !== null) ? (double) $row[$startcol + 5] : null;
            $this->resetModified();
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            ...
            foreach (sfMixer::getCallables('BaseFacturaDetalle:delete:pre') as $callable)
            {
            ...
            if ($ret) {
                ...
                $this->postDelete($con);
                // symfony_behaviors behavior
                foreach (sfMixer::getCallables('BaseFacturaDetalle:delete:post') as $callable)
                {
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            // symfony_behaviors behavior
            foreach (sfMixer::getCallables('BaseFacturaDetalle:save:pre') as $callable)
            {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                // symfony_behaviors behavior
                foreach (sfMixer::getCallables('BaseFacturaDetalle:save:post') as $callable)
                {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(FacturaDetallePeer::PROVEEDOR_ID)) $criteria->add(FacturaDetallePeer::PROVEEDOR_ID, $this->proveedor_id);
    ...
    public function getProveedor(PropelPDO $con = null)
    {
        if ($this->aProveedor === null && ($this->proveedor_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aProveedor->addFacturaDetalles($this);
             */
        }
    ...
    public function __call($name, $params)
    {
        ...
        // symfony_behaviors behavior
        if ($callable = sfMixer::getCallable('BaseFacturaDetalle:' . $name))
        {
