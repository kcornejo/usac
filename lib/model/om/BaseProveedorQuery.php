...
abstract class BaseProveedorQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT `ID`, `NOMBRE`, `DIRECCION`, `CORREO_ELETRONICO`, `NOMBRE_CONTACTO`, `TELEFONO`, `CIUDAD`, `OBSERVACION`, `NIT`, `RAZON_SOCIAL`, `CONTACTO`, `REFERENCIA` FROM `proveedor` WHERE `ID` = :p0';
        try {
