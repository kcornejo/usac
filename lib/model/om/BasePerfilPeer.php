...
abstract class BasePerfilPeer
{
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'Descripcion', 'CreatedAt', 'UpdatedAt', 'CreatedBy', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'descripcion', 'createdAt', 'updatedAt', 'createdBy', ),
        BasePeer::TYPE_COLNAME => array (PerfilPeer::ID, PerfilPeer::DESCRIPCION, PerfilPeer::CREATED_AT, PerfilPeer::UPDATED_AT, PerfilPeer::CREATED_BY, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'DESCRIPCION', 'CREATED_AT', 'UPDATED_AT', 'CREATED_BY', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'descripcion', 'created_at', 'updated_at', 'created_by', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Descripcion' => 1, 'CreatedAt' => 2, 'UpdatedAt' => 3, 'CreatedBy' => 4, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'descripcion' => 1, 'createdAt' => 2, 'updatedAt' => 3, 'createdBy' => 4, ),
        BasePeer::TYPE_COLNAME => array (PerfilPeer::ID => 0, PerfilPeer::DESCRIPCION => 1, PerfilPeer::CREATED_AT => 2, PerfilPeer::UPDATED_AT => 3, PerfilPeer::CREATED_BY => 4, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'DESCRIPCION' => 1, 'CREATED_AT' => 2, 'UPDATED_AT' => 3, 'CREATED_BY' => 4, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'descripcion' => 1, 'created_at' => 2, 'updated_at' => 3, 'created_by' => 4, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, )
    );
