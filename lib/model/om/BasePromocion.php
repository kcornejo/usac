...
abstract class BasePromocion extends BaseObject implements Persistent
{
    ...
    public function setActivo($v)
    {
        ...
        if ($this->activo !== $v) {
            $this->activo = $v;
            $this->modifiedColumns[] = PromocionPeer::ACTIVO;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->activo = ($row[$startcol + 1] !== null) ? (boolean) $row[$startcol + 1] : null;
            ...
            $this->descuento = ($row[$startcol + 5] !== null) ? (double) $row[$startcol + 5] : null;
            $this->resetModified();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(PromocionPeer::ACTIVO)) {
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[1], $arr)) $this->setActivo($arr[$keys[1]]);
        ...
        if (array_key_exists($keys[5], $arr)) $this->setDescuento($arr[$keys[5]]);
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(PromocionPeer::ACTIVO)) $criteria->add(PromocionPeer::ACTIVO, $this->activo);
