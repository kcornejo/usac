 ...
 * 11/12/15 08:06:33
 *
 * @method TipoUsuarioQuery orderById($order = Criteria::ASC) Order by the id column
 * @method TipoUsuarioQuery orderByNombre($order = Criteria::ASC) Order by the nombre column
 * @method TipoUsuarioQuery orderByDescripcion($order = Criteria::ASC) Order by the descripcion column
 *
 * @method TipoUsuarioQuery groupById() Group by the id column
 * @method TipoUsuarioQuery groupByNombre() Group by the nombre column
 ...
 *
 * @method TipoUsuario findOneById(int $id) Return the first TipoUsuario filtered by the id column
 * @method TipoUsuario findOneByNombre(string $nombre) Return the first TipoUsuario filtered by the nombre column
 ...
 *
 * @method array findById(int $id) Return TipoUsuario objects filtered by the id column
 * @method array findByNombre(string $nombre) Return TipoUsuario objects filtered by the nombre column
...
abstract class BaseTipoUsuarioQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT `ID`, `NOMBRE`, `DESCRIPCION` FROM `tipo_usuario` WHERE `ID` = :p0';
        try {
    ...
    public function filterByPrimaryKey($key)
    {
        ...
        return $this->addUsingAlias(TipoUsuarioPeer::ID, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(TipoUsuarioPeer::ID, $keys, Criteria::IN);
    }
    ...
    public function filterById($id = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(TipoUsuarioPeer::ID, $id, $comparison);
    }
    ...
    public function filterByNombre($nombre = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(TipoUsuarioPeer::NOMBRE, $nombre, $comparison);
    }
