...
abstract class BaseMarca extends BaseObject implements Persistent
{
    ...
    public function setNombre($v)
    {
        ...
        if ($this->nombre !== $v) {
            $this->nombre = $v;
            $this->modifiedColumns[] = MarcaPeer::NOMBRE;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = MarcaPeer::CREATED_AT;
            }
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = MarcaPeer::UPDATED_AT;
            }
        } // if either are not null
    ...
    public function setCreatedBy($v)
    {
        ...
        if ($this->created_by !== $v) {
            $this->created_by = $v;
            $this->modifiedColumns[] = MarcaPeer::CREATED_BY;
        }
    ...
    public function setUpdatedBy($v)
    {
        ...
        if ($this->updated_by !== $v) {
            $this->updated_by = $v;
            $this->modifiedColumns[] = MarcaPeer::UPDATED_BY;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 7; // 7 = MarcaPeer::NUM_HYDRATE_COLUMNS.
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($this->isModified() && !$this->isColumnModified(MarcaPeer::UPDATED_AT))
            {
            ...
            if ($isInsert) {
                ...
                // symfony_timestampable behavior
                if (!$this->isColumnModified(MarcaPeer::CREATED_AT))
                {
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(MarcaPeer::NOMBRE)) {
        ...
        if ($this->isColumnModified(MarcaPeer::UPDATED_AT)) {
            $modifiedColumns[':p' . $index++]  = '`UPDATED_AT`';
        }
        if ($this->isColumnModified(MarcaPeer::CREATED_BY)) {
            $modifiedColumns[':p' . $index++]  = '`CREATED_BY`';
        }
        if ($this->isColumnModified(MarcaPeer::UPDATED_BY)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(MarcaPeer::NOMBRE)) $criteria->add(MarcaPeer::NOMBRE, $this->nombre);
        if ($this->isColumnModified(MarcaPeer::DESCRIPCION)) $criteria->add(MarcaPeer::DESCRIPCION, $this->descripcion);
        if ($this->isColumnModified(MarcaPeer::CREATED_AT)) $criteria->add(MarcaPeer::CREATED_AT, $this->created_at);
        if ($this->isColumnModified(MarcaPeer::UPDATED_AT)) $criteria->add(MarcaPeer::UPDATED_AT, $this->updated_at);
        if ($this->isColumnModified(MarcaPeer::CREATED_BY)) $criteria->add(MarcaPeer::CREATED_BY, $this->created_by);
        if ($this->isColumnModified(MarcaPeer::UPDATED_BY)) $criteria->add(MarcaPeer::UPDATED_BY, $this->updated_by);
