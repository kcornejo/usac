...
/**
 * Base class that represents a row from the 'tipo_producto' table.
 *
 * 
 *
 ...
 */
abstract class BaseTipoProducto extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'TipoProductoPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        TipoProductoPeer
     */
     ...
     * @return TipoProducto The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = TipoProductoPeer::ID;
        }
    ...
    public function setNombre($v)
    {
        ...
        if ($this->nombre !== $v) {
            $this->nombre = $v;
            $this->modifiedColumns[] = TipoProductoPeer::NOMBRE;
        }
    ...
    public function setDescripcion($v)
    {
        ...
        if ($this->descripcion !== $v) {
            $this->descripcion = $v;
            $this->modifiedColumns[] = TipoProductoPeer::DESCRIPCION;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 3; // 3 = TipoProductoPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating TipoProducto object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = TipoProductoPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = TipoProductoQuery::create()
                ->filterByPrimaryKey($this->getPrimaryKey());
            $ret = $this->preDelete($con);
            // symfony_behaviors behavior
            foreach (sfMixer::getCallables('BaseTipoProducto:delete:pre') as $callable)
            {
            ...
            if ($ret) {
                ...
                $this->postDelete($con);
                // symfony_behaviors behavior
                foreach (sfMixer::getCallables('BaseTipoProducto:delete:post') as $callable)
                {
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            // symfony_behaviors behavior
            foreach (sfMixer::getCallables('BaseTipoProducto:save:pre') as $callable)
            {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                // symfony_behaviors behavior
                foreach (sfMixer::getCallables('BaseTipoProducto:save:post') as $callable)
                {
                  call_user_func($callable, $this, $con, $affectedRows);
                }

                TipoProductoPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(TipoProductoPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`ID`';
        }
        if ($this->isColumnModified(TipoProductoPeer::NOMBRE)) {
            $modifiedColumns[':p' . $index++]  = '`NOMBRE`';
        }
        if ($this->isColumnModified(TipoProductoPeer::DESCRIPCION)) {
            $modifiedColumns[':p' . $index++]  = '`DESCRIPCION`';
        }

        $sql = sprintf(
            'INSERT INTO `tipo_producto` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = TipoProductoPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = TipoProductoPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['TipoProducto'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['TipoProducto'][$this->getPrimaryKey()] = true;
        $keys = TipoProductoPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(TipoProductoPeer::ID)) $criteria->add(TipoProductoPeer::ID, $this->id);
        if ($this->isColumnModified(TipoProductoPeer::NOMBRE)) $criteria->add(TipoProductoPeer::NOMBRE, $this->nombre);
        if ($this->isColumnModified(TipoProductoPeer::DESCRIPCION)) $criteria->add(TipoProductoPeer::DESCRIPCION, $this->descripcion);
    ...
    {
        $criteria = new Criteria(TipoProductoPeer::DATABASE_NAME);
        $criteria->add(TipoProductoPeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of TipoProducto (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return TipoProducto Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return TipoProductoPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new TipoProductoPeer();
        }
     ...
     * If this TipoProducto is new, it will return
    ...
    public function setProductos(PropelCollection $productos, PropelPDO $con = null)
    {
        ...
        foreach ($this->productosScheduledForDeletion as $productoRemoved) {
            $productoRemoved->setTipoProducto(null);
        }
     ...
     * Otherwise if this TipoProducto is new, it will return
     * an empty collection; or if this TipoProducto has previously
     * been saved, it will retrieve related Productos from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in TipoProducto.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
     ...
     * @return PropelObjectCollection|Producto[] List of Producto objects
     */
    public function getProductosJoinTipoPresentacion($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = ProductoQuery::create(null, $criteria);
        $query->joinWith('TipoPresentacion', $join_behavior);
    ...
    public function __call($name, $params)
    {
        ...
        // symfony_behaviors behavior
        if ($callable = sfMixer::getCallable('BaseTipoProducto:' . $name))
        {
