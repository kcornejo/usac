...
abstract class BaseProductoPeer
{
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'Descripcion', 'Precio', 'MarcaId', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'descripcion', 'precio', 'marcaId', ),
        BasePeer::TYPE_COLNAME => array (ProductoPeer::ID, ProductoPeer::DESCRIPCION, ProductoPeer::PRECIO, ProductoPeer::MARCA_ID, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'DESCRIPCION', 'PRECIO', 'MARCA_ID', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'descripcion', 'precio', 'marca_id', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Descripcion' => 1, 'Precio' => 2, 'MarcaId' => 3, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'descripcion' => 1, 'precio' => 2, 'marcaId' => 3, ),
        BasePeer::TYPE_COLNAME => array (ProductoPeer::ID => 0, ProductoPeer::DESCRIPCION => 1, ProductoPeer::PRECIO => 2, ProductoPeer::MARCA_ID => 3, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'DESCRIPCION' => 1, 'PRECIO' => 2, 'MARCA_ID' => 3, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'descripcion' => 1, 'precio' => 2, 'marca_id' => 3, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, )
    );
