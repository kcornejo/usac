...
abstract class BaseProductoPeer
{
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'Descripcion', 'MarcaId', 'TipoProductoId', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'descripcion', 'marcaId', 'tipoProductoId', ),
        BasePeer::TYPE_COLNAME => array (ProductoPeer::ID, ProductoPeer::DESCRIPCION, ProductoPeer::MARCA_ID, ProductoPeer::TIPO_PRODUCTO_ID, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'DESCRIPCION', 'MARCA_ID', 'TIPO_PRODUCTO_ID', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'descripcion', 'marca_id', 'tipo_producto_id', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Descripcion' => 1, 'MarcaId' => 2, 'TipoProductoId' => 3, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'descripcion' => 1, 'marcaId' => 2, 'tipoProductoId' => 3, ),
        BasePeer::TYPE_COLNAME => array (ProductoPeer::ID => 0, ProductoPeer::DESCRIPCION => 1, ProductoPeer::MARCA_ID => 2, ProductoPeer::TIPO_PRODUCTO_ID => 3, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'DESCRIPCION' => 1, 'MARCA_ID' => 2, 'TIPO_PRODUCTO_ID' => 3, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'descripcion' => 1, 'marca_id' => 2, 'tipo_producto_id' => 3, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, )
    );
