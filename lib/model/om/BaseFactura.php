...
abstract class BaseFactura extends BaseObject implements Persistent
{
    ...
    public function setClienteId($v)
    {
        ...
        if ($this->cliente_id !== $v) {
            $this->cliente_id = $v;
            $this->modifiedColumns[] = FacturaPeer::CLIENTE_ID;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = FacturaPeer::CREATED_AT;
            }
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = FacturaPeer::UPDATED_AT;
            }
        } // if either are not null
    ...
    public function setCreatedBy($v)
    {
        ...
        if ($this->created_by !== $v) {
            $this->created_by = $v;
            $this->modifiedColumns[] = FacturaPeer::CREATED_BY;
        }
    ...
    public function setUpdatedBy($v)
    {
        ...
        if ($this->updated_by !== $v) {
            $this->updated_by = $v;
            $this->modifiedColumns[] = FacturaPeer::UPDATED_BY;
        }
    ...
    public function setTipoPagoId($v)
    {
        ...
        if ($this->tipo_pago_id !== $v) {
            $this->tipo_pago_id = $v;
            $this->modifiedColumns[] = FacturaPeer::TIPO_PAGO_ID;
        }
    ...
    public function setActivo($v)
    {
        ...
        if ($this->activo !== $v) {
            $this->activo = $v;
            $this->modifiedColumns[] = FacturaPeer::ACTIVO;
        }
    ...
    public function setSerie($v)
    {
        ...
        if ($this->serie !== $v) {
            $this->serie = $v;
            $this->modifiedColumns[] = FacturaPeer::SERIE;
        }
    ...
    public function setDocumento($v)
    {
        ...
        if ($this->documento !== $v) {
            $this->documento = $v;
            $this->modifiedColumns[] = FacturaPeer::DOCUMENTO;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->tipo_pago_id = ($row[$startcol + 7] !== null) ? (int) $row[$startcol + 7] : null;
            $this->activo = ($row[$startcol + 8] !== null) ? (boolean) $row[$startcol + 8] : null;
            $this->fecha = ($row[$startcol + 9] !== null) ? (string) $row[$startcol + 9] : null;
            $this->serie = ($row[$startcol + 10] !== null) ? (string) $row[$startcol + 10] : null;
            $this->documento = ($row[$startcol + 11] !== null) ? (string) $row[$startcol + 11] : null;
            $this->resetModified();
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($this->isModified() && !$this->isColumnModified(FacturaPeer::UPDATED_AT))
            {
            ...
            if ($isInsert) {
                ...
                // symfony_timestampable behavior
                if (!$this->isColumnModified(FacturaPeer::CREATED_AT))
                {
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(FacturaPeer::CLIENTE_ID)) {
            $modifiedColumns[':p' . $index++]  = '`CLIENTE_ID`';
        }
        if ($this->isColumnModified(FacturaPeer::CREATED_AT)) {
            $modifiedColumns[':p' . $index++]  = '`CREATED_AT`';
        }
        if ($this->isColumnModified(FacturaPeer::UPDATED_AT)) {
            $modifiedColumns[':p' . $index++]  = '`UPDATED_AT`';
        }
        if ($this->isColumnModified(FacturaPeer::CREATED_BY)) {
            $modifiedColumns[':p' . $index++]  = '`CREATED_BY`';
        }
        if ($this->isColumnModified(FacturaPeer::UPDATED_BY)) {
            $modifiedColumns[':p' . $index++]  = '`UPDATED_BY`';
        }
        if ($this->isColumnModified(FacturaPeer::TOTAL)) {
            $modifiedColumns[':p' . $index++]  = '`TOTAL`';
        }
        if ($this->isColumnModified(FacturaPeer::TIPO_PAGO_ID)) {
            $modifiedColumns[':p' . $index++]  = '`TIPO_PAGO_ID`';
        }
        if ($this->isColumnModified(FacturaPeer::ACTIVO)) {
            $modifiedColumns[':p' . $index++]  = '`ACTIVO`';
        }
        if ($this->isColumnModified(FacturaPeer::FECHA)) {
            $modifiedColumns[':p' . $index++]  = '`FECHA`';
        }
        if ($this->isColumnModified(FacturaPeer::SERIE)) {
            $modifiedColumns[':p' . $index++]  = '`SERIE`';
        }
        if ($this->isColumnModified(FacturaPeer::DOCUMENTO)) {
    ...
    public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        $result = array(
            ...
            $keys[7] => $this->getTipoPagoId(),
            $keys[8] => $this->getActivo(),
            $keys[9] => $this->getFecha(),
            $keys[10] => $this->getSerie(),
            $keys[11] => $this->getDocumento(),
        );
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[7], $arr)) $this->setTipoPagoId($arr[$keys[7]]);
        if (array_key_exists($keys[8], $arr)) $this->setActivo($arr[$keys[8]]);
        if (array_key_exists($keys[9], $arr)) $this->setFecha($arr[$keys[9]]);
        if (array_key_exists($keys[10], $arr)) $this->setSerie($arr[$keys[10]]);
        if (array_key_exists($keys[11], $arr)) $this->setDocumento($arr[$keys[11]]);
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(FacturaPeer::CLIENTE_ID)) $criteria->add(FacturaPeer::CLIENTE_ID, $this->cliente_id);
        if ($this->isColumnModified(FacturaPeer::CREATED_AT)) $criteria->add(FacturaPeer::CREATED_AT, $this->created_at);
        if ($this->isColumnModified(FacturaPeer::UPDATED_AT)) $criteria->add(FacturaPeer::UPDATED_AT, $this->updated_at);
        if ($this->isColumnModified(FacturaPeer::CREATED_BY)) $criteria->add(FacturaPeer::CREATED_BY, $this->created_by);
        if ($this->isColumnModified(FacturaPeer::UPDATED_BY)) $criteria->add(FacturaPeer::UPDATED_BY, $this->updated_by);
        if ($this->isColumnModified(FacturaPeer::TOTAL)) $criteria->add(FacturaPeer::TOTAL, $this->total);
        if ($this->isColumnModified(FacturaPeer::TIPO_PAGO_ID)) $criteria->add(FacturaPeer::TIPO_PAGO_ID, $this->tipo_pago_id);
        if ($this->isColumnModified(FacturaPeer::ACTIVO)) $criteria->add(FacturaPeer::ACTIVO, $this->activo);
        if ($this->isColumnModified(FacturaPeer::FECHA)) $criteria->add(FacturaPeer::FECHA, $this->fecha);
        if ($this->isColumnModified(FacturaPeer::SERIE)) $criteria->add(FacturaPeer::SERIE, $this->serie);
        if ($this->isColumnModified(FacturaPeer::DOCUMENTO)) $criteria->add(FacturaPeer::DOCUMENTO, $this->documento);
    ...
    public function getTipoPago(PropelPDO $con = null)
    {
        if ($this->aTipoPago === null && ($this->tipo_pago_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aTipoPago->addFacturas($this);
             */
        }
