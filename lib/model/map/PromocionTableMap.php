...
class PromocionTableMap extends TableMap
{
    ...
    public function initialize()
    {
        ...
        $this->addColumn('FECHA_INICIO', 'FechaInicio', 'VARCHAR', false, 32, null);
        $this->addColumn('FECHA_FIN', 'FechaFin', 'VARCHAR', false, 32, null);
        $this->addForeignKey('PRODUCTO_ID', 'ProductoId', 'INTEGER', 'producto', 'ID', false, null, null);
        $this->addColumn('DESCUENTO', 'Descuento', 'DOUBLE', false, null, null);
        // validators
    } // initialize()
